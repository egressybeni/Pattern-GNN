...
class GATe(torch.nn.Module):
	def __init__(self, num_features, num_gnn_layers, n_classes=2, n_hidden=100, n_heads=4, embedding=False, edge_features=False, edge_updates=False, readout='node', residual=True, edge_dim=None, dropout=0.0, final_dropout=0.5, reverse=True):
		super().__init__()
		# GAT specific code
